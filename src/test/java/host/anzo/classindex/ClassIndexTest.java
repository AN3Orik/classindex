...
import host.anzo.classindex.processor.Important;
import host.anzo.classindex.processor.Plugin;
import host.anzo.classindex.second.ExtraPlugin;
...
public class ClassIndexTest {
	...
	public void shouldReturnNamesOfAnnotated() {
		...
		assertThat(annotated).containsOnly(
				...
				"host.anzo.classindex.DeletedComponent");
	}
